...
void main() {
  ...
  test('contradiction candidates remain suggestions', () {
    ...
    final notes = <Note>[
      Note(id: 'a', title: 'A', projectId: 'p', body: 'Protein binding increases at 20 degrees.'),
      Note(id: 'b', title: 'B', projectId: 'p', body: 'Protein binding does not increase at 20 degrees.'),
    ];
    final conflicts = LocalIntelligenceEngine().conflicts(LocalIntelligenceEngine().build(project, notes));
